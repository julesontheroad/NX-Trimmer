...
v0.3.1 - Reformada carpeta ztools para eliminar sfk.exe ya que no era necesario. Añadida la build de Bigjokker de hacbuild para eliminar la advertencia de falta de 
