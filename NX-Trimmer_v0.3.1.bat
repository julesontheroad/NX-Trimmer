...
echo.
echo It also works with NX-Trimmer_v0.3.1.bat "filename.xci" over the command line
echo.
...
:salida
echo This program only accepts xci files.
echo.
pause
exit
...
move  "%~dp0\xciDecrypted\*.nca" "%~dp0\output_nxt\!ofolder!" 
